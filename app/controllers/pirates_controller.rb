class PiratesController < ApplicationController
  ...
  def update
    ...
    if @pirate
      if @pirate.update_attributes(pirate_params)
        redirect_to pirates_path, success: "Pirate's changes has been saved t' rthe registe"
      else
  ...
  def create
    ...
    if @pirate.save
      redirect_to pirates_path, success: "A new pirate has been add t' th' crew !"
    else
      redirect_to pirates_path, alert: "Bloody Davy Jones' locker. 'tis wrong !"
    end
  end
  ...
  def destroy
    ...
    redirect_to pirates_path, alert: "Bloody Davy Jones' locker. 'tis wrong !" unless @pirate
    @pirate.destroy
    redirect_to pirates_path, success: "Ahahahaha ! Ye did it ! We scuttle this useless brat !"
  end
